...
public class GridViewAdapter extends ArrayAdapter<GridItem> {
    ...
    public GridViewAdapter(Context context, int layoutResource, ArrayList<GridItem> gridData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final GridItem gridItem = gridData.get(position);
        ...
        row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, gridItem.getText(), Toast.LENGTH_SHORT).show();
                Intent shelfActivityIntent = new Intent(context, ShelfActivity.class);
                shelfActivityIntent.putExtra("Category", gridItem.getText());
                context.startActivity(shelfActivityIntent);
            }
        });
